...
function fPrintAdminPanel($action)
{
   ...
   {
      print("\t<td class=\"abutton1\">&nbsp;</td>\n");
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&amp;action=users", "btn_users_groups");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&amp;action=edhtml", "btn_html_prefs");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&amp;action=edprefs", "btn_site_features");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/stats.php?sess=$sess", "btn_statistics_viewer");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/news.php?sess=$sess", "btn_news_admin");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/doctype.php?sess=$sess", "btn_doctype_admin");
   }
   
   if (file_exists($default->dbdump_path) && file_exists($default->gzip_path))
   {
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&amp;action=backup", "btn_backup");
   }
   else
   {
   ...
   if ($default->collect_trash == 1)
   {
      ...
      {
         if (is_dir($default->trash_can_location . DIR_SEP . $default->owl_current_db . DIR_SEP . $sRootFolderName) || is_dir($default->trash_can_location))
         {
            ...
            if ($iFileCounter > 0)
            {
               fPrintButton($default->owl_root_url . "/admin/recycle.php?sess=$sess", "btn_trashcan");
            }
            else
            {
               print("\t<td class=\"abutton0\">&nbsp;");
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/import_users.php?sess=$sess", "btn_import_users");
   }
   ...
   {
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&maint=1", "btn_admin_maint_on");
   }
   else
   {
      fPrintButton($default->owl_root_url . "/admin/index.php?sess=$sess&maint=0", "btn_admin_maint_off");
   }
...
//****************************************************************************************************
   ...
   {
      print("\t<td class=\"abutton\">&nbsp;");
      print($owl_lang->tables_btn);
      print("</td>\n");
   }
   else
   {
      fPrintButton($default->owl_root_url . "/extensions/userTables.php?sess=$sess", "tables_btn");
   }
//****************************************************************************************************
// END ADD Filipe Lima (filipe.aclima@gmail.com) - March 2009
//****************************************************************************************************
