...
$TEMP_DIR                    = $default->ubr_progress_bar_tmp_dir."/"; // *ATTENTION : The $TEMP_DIR values MUST be duplicated in the "ubr_upload.pl" file
$UBER_VERSION                = '6.3.6';                      // Version of Uber-Uploader
...
$GET_PROGRESS_SPEED          = 1000;                         // How frequent the server is poled for upload status. 5000=5 seconds, 1000=1 second, 500=0.5 seconds. etc. 
