...
if($MULTI_CONFIGS_ENABLED){
	...
	// eg.   if($_SESSION['user_name'] == 'TOM'){ $config_file = 'tom_config.php'; }
	// eg.   if($_COOKIE['user_name'] == 'TOM'){ $config_file = 'tom_config.php'; }
...
<head>
  ...
  <!-- Please do not remove this tag: Uber-Uploader Ver 6.3.6 http://uber-uploader.sourceforge.net -->
  <style>
