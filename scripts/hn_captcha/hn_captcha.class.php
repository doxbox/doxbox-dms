...
class hn_captcha
{
	...
	//
		...
		function display_captcha($onlyTheImage=FALSE)
		{
			...
			else return $this->public_key_input()."\n".'<img class="captchapict" src="'.$this->get_filename_url().'" '.$is[3].' alt="BOZZ This is a captcha-picture. It is used to prevent mass-access by robots. (see: www.captcha.net)" title="">'."\n";
		}
