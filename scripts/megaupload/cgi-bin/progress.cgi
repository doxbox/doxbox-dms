...
sub make_progress_bar
{
 ...
 <html>
        <head>
         ...
         <link rel="stylesheet" type="text/css" title="style1" href="/owl-0.96/graphics/rsdx_blue1/styles.css"></link>
 	 <meta HTTP-EQUIV=Refresh CONTENT="$interval; URL=$url"></head>
         </head>
        <body onLoad="window.focus();" onBlur="setTimeout('window.focus()', 100);">
        <center>
                <br />
                <table class="form1" border=0 width="90%">
                  <tr><TD class="admin3" align="center">File Upload In Progress</td></tr>
                  <tr><td>
                <table border=0 width='100%'>
                          <tr><td>
                           <table border='1' width='$percent%' bgcolor='darkblue'>
	...
	print <<__PART2__;
		...
		<body onLoad="window.focus();" onBlur="setTimeout('window.focus()', 100);">
		  <table class="form1" align="center">
		   <tr><td class="admin3" align="center">File Upload Complete</td></tr>
			<tr>
				<td>
					Status: $bRead bytes of $iTotal sent (at $bSpeedf Kbps)<br />
		   ...
		   <tr><td align="center"><a class="file1" href="javascript:parent.window.close();">close</a></td></tr>
		  </table>
		</body>
		</html>
__PART2__
...
<link rel="stylesheet" type="text/css" title="style1" href="/owl-0.96/graphics/rsdx_blue1/styles.css"></link>
		...
		<body onLoad="window.focus();" onBlur="setTimeout('window.focus()', 100);">
		 <table class="form1" align="center"><tr><td class="admin3">File Upload in progress</td></tr></table>
		</body>
		</html>
__PART2__
}
...
<link rel="stylesheet" type="text/css" title="style1" href="/owl-0.96/graphics/rsdx_blue1/styles.css"></link>
		<meta HTTP-EQUIV=Refresh CONTENT="$interval; URL=$url"></head>
		<body onLoad="window.focus();" onBlur="setTimeout('window.focus()', 100);">File Upload in progress, total file size uncertain.</body>
		</html>
__PART2__
