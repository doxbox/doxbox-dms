...
* @return void
*/
function setTreeLeafImage($treeLeafImage)
{
	$this->treeLeafImage = $treeLeafImage;
}
	...
	)
{
	...
	$alt_folder_open		= '->';
        $img_leaf_name                  = $this->treeLeafImage;
	$img_leaf			= $this->imgwww . $this->treeMenuTheme . $img_leaf_name . '.' . $this->treeMenuImagesType;
