...
/**
 * REST API to interact with DoxBox DMS
 */
...
class DmsAPI
{
   ...
   /**  
    * Array that holds the key as defined in the ini file
    * You can generate these keys using the supplied
    * genapikey.php
    * @ignore
    */
   ...
   /**
    * Class Construct to Initialize Variables for access to the Doxox Database
    * and global Variable $default
    */
   ...
   */
   ...
   /**
    *
    * This Method Authenticates a user to the doxbox DMS. DoxBox User and Password Authentication 
    * is the only authentication method that is supported at this time. 
    *
    * @param  string  $sUsername   Username to authenticate.
    * @param  string  $sPassword   MD5 Hash of the Users Password.
    * @param  string  $sUserAPIKey API Key generated using ./genapikey.php  <IP ADDRESS>.
    * @param  string  $fConfig     <p>Optional location of the api config file that contains the 
    *                              Authorized API Keys. <br />
    *                              Default Location: ./config/api.config.php.</p>
    *
    * @throws array   $aError      On error Contains an error number and associated error message.
    *
    *       Array
    *       (
    *          [code] => 0010
    *          [msg] => You API KEY is Missing Access Denied
    *       )
    *
    * @throws array   $aSession   Containing a valild Session ID to be used in subsequent Methods.
    *
    *       Array
    *       (
    *          [sessid] => 3f0265c2f54dc5802fb557af55e3287b
    *       )
    *
    * @return string  
    *                 The thrown array is parsed by the 'Response' Method into a JSON or XML 
    *                 string, depending on ResponseType Requested by the Server. Then Sent back 
    *                 to the client to be parsed and appropiate action taken by the client.
    */
   ...
   public function VerifyCredential($sUsername, $sPassword, $sUserAPIKey, $fConfig = './config/api.config.php') 
   {
      ...
      */ 
      ...
      else if ($aVerified['bit'] == 1)
      {
         ...
         $aSession = array();
         $aSession['sessid'] = $uid->sessdata["sessid"];

         throw new Exception($this->Response($aSession));
      }
      else
      {
         $aError = array();
         $aError['code'] = AUTH_FAILED;
         $aError['msg'] = 'Authentication Failed';
    ...
    *
    * @param  string  $sSessID     Valid SessionID to destroy in order to logout the user from DoxBox DMS
    * 
    * @throws array   $aError      On error Contains an error number and associated error message.
    *
    *       Array
    ...
    *       )
    *
    * @return string  <p>The thrown array is parsed by the 'Response' Method into a JSON or XML 
    *                 string, depending on ResponseType Requested by the Server. Then Sent back 
    *                 to the client to be parsed and appropiate action taken by the client.</p>
    */
   ...
   /**
    * @ignore
    * [NOT IMPLEMENTED] Provides a list of Files and Folders within a Given Folder ID
    *
   ...
   /**
    * @ignore
    * [NOT IMPLEMENTED] Deletes a Folder from the DoxBox DMS
    *
    * @param  string  $iFolderID     Unique Folder ID 
    * @throws 
    * @return string
    ...
    *
    * @param  string  $sSessID     Valid Session ID String
    * @param  string  $iFileID     Unique DoxBox DMS File ID to delete
    * 
    * @throws array   $aError      On error Contains an error number and associated error message.
    *
    *       Array
   ...
   */
    ...
    *
    * @param  string  $sSessID       Valid Session ID String
    * @param  int     $iParentID     ID of the Parent Folder where to create the folder
    * @param  string  $sFolderName   Name of Folder to be created created
    * @param  int     $iOwnerUserID  <b>OPTIONAL</b> DoxBox User ID that should be the Owner of this Folder
    * @param  int     $iOwnerGroupID <b>OPTIONAL</b> DoxBox Group ID that should be the Owner of this Folder 
    * 
    * @throws array   $aError        <p>On error Contains an error number and associated error message.<br />
    * On Success [new_folder_id] => new_folder_id is returned</p>
    *
    *       Array
    *       (
    *          [code] => ####
   ...
   */
    ...
    *
    * @param  string  $sSessID        Valid Session ID String
    * @param  int     $iFileID        Unique File ID of the file to download
    * @param  array   $aCustomHeaders <p><b>OPTIONAL</b> Allows for MetaData to be passed back with 
    *                                 the File see sampleclient.php for an example</p>
    * @param  bool    $bCompressed    <p><b>OPTIONAL</b> Tells thee Method to return the file ZIPPED or Not.
    *                                 <b>Default</b>: False</p>
    * 
    * @throws array   $aError      On error Contains an error number and associated error message.
    *
   ...
   /**
    * Update a single File to the DoxBox DMS. Currently not Supported if you have version
    * control turned off.  Alternative is to Delete the file via the DeleteFile Method First.
    *
    * @param  string  $sSessID         Valid Session ID String
    * @param  int     $iFileID         DoxBox File ID to be Updated
    * @param  string  $sVersionChange <b>OPTIONAL</b> is this a Major or a Minor Revision Update for this file.
    *                                 <b>Default</b>: minor
    *
    * @throws array   $aError         <p>On error Contains an error number and associated error message. On Success also returns [backup_file_id]</p>
    *
    *       Array
    *       (
    *          [code] => ####
    ...
    *                to the client to be parsed and appropiate action taken by the client.</p>
    * 
    * @todo Implement File Update For Version Control Turned Off
    */
   ...
   */
    ...
    *
    * @param  string  $sSessID       Valid Session ID String
    * @param  int     $iParentID     DoxBox DMS Folder ID where the File should be Uploaded
    * 
    * @throws array   $aError        <p>On error Contains an error number and associated error message.<br />On 
    *                                Success [new_file_id] => new_file_id is returned</p>
    *
    *       Array
    *       (
    *          [code] => ####
   ...
   */
    ...
    * @param  string  $sFullName   <b>OPTIONAL</b> User's Full Name
    * @param  int     $iHomeDirID  <b>OPTIONAL</b> User's Home and First Directory ID. Default: 1 (Documents Folder)
    * @param  bool    $bGroupAdmin <b>OPTIONAL</b> Is this user a Group Administrator. Default: 0 (False)
    * @param  int     $sQuotaMax   <b>OPTIONAL</b> User's Max Quota in bytes. Default: 0 (No Quota)
    * 
    * @throws array   $aError        <p>On error Contains an error number and associated error message.<br />On 
    * Success [new_file_id] => new_file_id is returned</p>
    *
   ...
   * @param  
   * @throws 
   * @return  string  XML Response With The Version Number and current Class Support Restrictions
   */
   public function Version() 
   {
      ...
      {
         $aError['owl_version_control'] = 'Support for Updating Files is only supported with the Version Control Feature Turned ON';
      }
   ...
   */
    ...
    * @param  
    * @throws 
    * @return object  $cDbConnection  AdoDB Database Connect Object
    */
    ...
    *
    * @param  string $sSessID 	Session ID String to Validate
    *
    * @throws array   $aError      On error Contains an error number and associated error message.
    *
    *       Array
   ...
   */
   ...
   /**
    * @ignore
    * Walks a PHP array recursively and converts it to an XML Object
    * 
    * @param  array   $aArray        PHP Array To convert 
    * @param  object  $xml           Initialized XML Ojbect
    * @throws 
    ...
    * 
    * @param  int      $code PHP UPLOAD_ERR  codes
    * @throws 
    * @return array    Human Readable message
    *
    *       Array
    *       (
