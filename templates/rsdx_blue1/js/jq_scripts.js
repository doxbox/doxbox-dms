...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/rsdx_blue1/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/rsdx_blue1/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/rsdx_blue1/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/rsdx_blue1/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/rsdx_blue1/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/rsdx_blue1/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/rsdx_blue1/lightbox/lightbox-blank.gif'
  });
