...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/linkpoint/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/linkpoint/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/linkpoint/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/linkpoint/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/linkpoint/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/linkpoint/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/linkpoint/lightbox/lightbox-blank.gif'
  });
