...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/linkpoint/ui_misc/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/linkpoint/ui_misc/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/linkpoint/img/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/linkpoint/img/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/linkpoint/img/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/linkpoint/img/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/linkpoint/img/lightbox/lightbox-blank.gif'
  });
    ...
    if (jQuery.browser.msie) {
      ...
      jQuery('#nav_bar_bottom').width(jQuery('.width_driver').width()-11);
                ...
                jQuery( "#expires" ).datetimepicker({
                        ...
                        buttonImage: "templates/linkpoint/ui_icons/calendar_day.png",
