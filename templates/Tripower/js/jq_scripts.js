...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/Tripower/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/Tripower/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/Tripower/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/Tripower/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/Tripower/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/Tripower/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/Tripower/lightbox/lightbox-blank.gif'
  });
