...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/bmgf_green/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/bmgf_green/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/bmgf_green/lightbox/lightbox-ico-loading.gif',
    imageBtnClose:'templates/bmgf_green/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/bmgf_green/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/bmgf_green/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/bmgf_green/lightbox/lightbox-blank.gif'
  });
