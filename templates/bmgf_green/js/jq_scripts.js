...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/bmgf_green/ui_misc/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/bmgf_green/ui_misc/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/bmgf_green/img/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/bmgf_green/img/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/bmgf_green/img/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/bmgf_green/img/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/bmgf_green/img/lightbox/lightbox-blank.gif'
  });
    ...
    if (jQuery.browser.msie) {
      ...
      jQuery('#nav_bar_bottom').width(jQuery('.width_driver').width()-11);
                ...
                jQuery( "#expires" ).datetimepicker({
                        ...
                        buttonImage: "templates/bmgf_green/ui_icons/calendar_day.png",
