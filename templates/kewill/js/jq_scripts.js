...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/kewill/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/kewill/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/kewill/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/kewill/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/kewill/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/kewill/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/kewill/lightbox/lightbox-blank.gif'
  });
