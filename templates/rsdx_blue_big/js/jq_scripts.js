...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/rsdx_blue_big/ui_misc/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/rsdx_blue_big/ui_misc/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/rsdx_blue_big/img/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/rsdx_blue_big/img/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/rsdx_blue_big/img/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/rsdx_blue_big/img/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/rsdx_blue_big/img/lightbox/lightbox-blank.gif'
  });
    ...
    if (jQuery.browser.msie) {
      ...
      jQuery('#nav_bar_bottom').width(jQuery('.width_driver').width()-11);
                ...
                jQuery( "#expires" ).datetimepicker({
                        ...
                        buttonImage: "templates/rsdx_blue_big/ui_icons/calendar_day.png",
...
// main menu
  ...
  jQuery('#menu_container_toggler, #top_mainmenu h3').click(function (){
    if( jQuery('#menu_container').is(':visible') ) {
