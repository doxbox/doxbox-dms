...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/yesi_RedGrey/ui_misc/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/yesi_RedGrey/ui_misc/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/yesi_RedGrey/img/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/yesi_RedGrey/img/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/yesi_RedGrey/img/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/yesi_RedGrey/img/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/yesi_RedGrey/img/lightbox/lightbox-blank.gif'
  });
    ...
    if (jQuery.browser.msie) {
      ...
      jQuery('#nav_bar_bottom').width(jQuery('.width_driver').width()-11);
                ...
                jQuery( "#expires" ).datetimepicker({
                        ...
                        buttonImage: "templates/yesi_RedGrey/ui_icons/calendar_day.png",
