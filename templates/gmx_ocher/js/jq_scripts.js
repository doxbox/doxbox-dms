...
//Medium Thumbs functions
  ...
  jQuery.imgpreload('templates/gmx_ocher/img/ajax-loader.gif', function(){
    mediumThumb();  
  });	
  	...
  	jQuery('.img_thumb img').hoverIntent(
  	  //rollover function
  		function() {
  		  ...
  		  jQuery(this).parents('.wrap_thumb').append('<div class="monitor"><img src="templates/gmx_ocher/img/ajax-loader.gif" title="ajaxloader" /></div>');
...
//Lightbox plugin Implementations
  ...
  jQuery('a.lightbox').lightBox({
    imageLoading: 'templates/gmx_ocher/lightbox/lightbox-ico-loading.gif',
    imageBtnClose: 'templates/gmx_ocher/lightbox/lightbox-btn-close.gif',
    imageBtnPrev: 'templates/gmx_ocher/lightbox/lightbox-btn-prev.png',
    imageBtnNext: 'templates/gmx_ocher/lightbox/lightbox-btn-next.png',
    imageBlank:   'templates/gmx_ocher/lightbox/lightbox-blank.gif'
  });
